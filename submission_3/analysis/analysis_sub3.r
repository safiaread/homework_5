...
labs(x = "Year", y = "% Direct Purchase Health Insurance", title = str_wrap("Share of the Adult Population with Direct Purchase Health Insurance over Time", 58))
...
geom_line()+
geom_vline(xintercept = 2013.5, color = "red")+
labs(x = "Year", y = "% Medicaid Insurance", title = str_wrap("Share of the Adult Population with Medicaid Insurance over Time", 53))
...
save.image("submission_3/Hwk5_workspace.Rdata")